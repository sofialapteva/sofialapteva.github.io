        ...
        <Container className="pt-20 pb-16 text-center lg:pt-32">
            <h1 className="mx-auto max-w-4xl font-display text-5xl font-medium tracking-tight text-slate-900 sm:text-7xl">
                ...
                <span className="relative whitespace-nowrap text-blue-600">
                    ...
                    <span className="relative">фронт-энд</span>
                </span>{' '}
                разработчиков.
            </h1>
            <p className="mx-auto mt-6 max-w-2xl text-lg tracking-tight text-slate-700">
                Актуальные рекомендации и лучшие практики в удобном формате.
            </p>
            <div className="mt-10 flex justify-center space-x-6">
                <ButtonLink href="/cheetsheets">Шпаргалки</ButtonLink>
                <ButtonLink
                    href="https://www.youtube.com/watch?v=dQw4w9WgXcQ"
                    variant="outline"
                >
                    <span className="ml-3">Ссылки</span>
                </ButtonLink>
            </div>
                ...
                <ul className="mt-8 flex items-center justify-center space-x-8 sm:flex-col sm:space-x-0 sm:space-y-10 xl:flex-row xl:space-y-0 xl:space-x-12">
                    <li>
                        <ul className="flex flex-col items-center space-y-8 sm:flex-row sm:space-y-0 sm:space-x-12">
                            ...
                            <li className="flex">
                                <img src={logoTuple} alt="Tuple" layout="fixed" />
                            </li>
                            <li className="flex">
                                <img
                                    src={logoStaticKit}
